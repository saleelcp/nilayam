...
$CONFIG = '{"lang":"en","error_reporting":true,"show_hidden":false,"hide_Cols":true,"calc_folder":true,"theme":"light"}';
...
$auth_users = array(
    'admin' => '$2y$10$RMRICkn3idds9Ns6OWOfuuqPWj/DdNLUkXTywfYdGGpAFAJ2AFm56', //admin@123
    'user' => '$2y$10$RMRICkn3idds9Ns6OWOfuuqPWj/DdNLUkXTywfYdGGpAFAJ2AFm56' //12345
);
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Saneej">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="http://www.saneejified.ml" target="_blank" class="app-v-title"> Saneej Files <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Saneej</p>
                        <p>Website: <a href="https://www.saneejified.ml">www.saneejified.ml</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Saneej <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Saneej <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Saneej';      $tr['en']['AppTitle']           = 'File Manager';
